...
function AdminPanel() {
  ...
  return (
    <div className="w-full h-screen p-2 ">
      <h1 className="text-[20px] font-semibold mt-3 text-green-500">Dashboard</h1>
      ...
      <div className="w-full mt-12 h-[60px] flex items-center gap-10">
        ...
        <button
          ...
          className="font-medium text-white w-[150px] h-11 rounded bg-green-500 hover:border-green-500"
        >
          Search
        </button>
      </div>
      ...
      <div className="mt-5">
        {searchResults.length > 0 ? (
         ...
         : (
          <p className="text-green-500 mt-5 pl-3">No results found. Try searching with a different CNIC.</p>
        )}
      </div>
    </div>
  );
