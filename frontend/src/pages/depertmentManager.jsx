  ...
  return (
    <div className="w-full h-screen ">
      <div className='w-full flex justify-center'>
        <h1 className='mx-auto mt-6 text-[22px] font-medium text-green-700'>Department Manager</h1>
      </div>
      <div className='w-[80%] mt-6 mx-auto h-12 flex items-center justify-between'>
        ...
        />
        <button
          className='w-[300px] font-medium bg-green-500 text-white rounded-lg h-full hover:bg-green-600 transition duration-300'
